...
public class Fenetre extends JFrame{
	...
	String[] tab_item = {"Quitter","Effacer","save","Fin","Moyen","Gras",
			"Rond","Carré","?","noir","bleu","rouge","vert"};
	...
	//les bouton de la barre d'outil avec leurs images
	 private JButton pen = new JButton(new ImageIcon("img/pen2.png")),
			 gomme = new JButton(new ImageIcon("img/gomme.png")),
			 carre = new JButton(new ImageIcon("img/carré.png")),
			 rond = new JButton(new ImageIcon("img/rond.png")),
			 noir = new JButton(new ImageIcon("img/noir.png")),
			 bleu = new JButton(new ImageIcon("img/bleu.png")),
			 vert = new JButton(new ImageIcon("img/vert.png")),
			 rouge = new JButton(new ImageIcon("img/rouge.png")),
			 fin = new JButton(new ImageIcon("img/petit.png")),
			 moyen = new JButton(new ImageIcon("img/moyen.png")),
			 gras = new JButton(new ImageIcon("img/grand.png"));
	...
	public Fenetre(){
		...
		content.setBackground(Color.white);//changement de la couleur principale
			...
			if(i==8){
				...
				item[8].addActionListener(new ActionListener() {	
					...
					public void actionPerformed(ActionEvent arg0) {			
						...
						jop.showMessageDialog(null,mess,"À propos de",
